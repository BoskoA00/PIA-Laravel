  ...
  <body>
    ...
    <div class="main">
        ...
        <div class="main-srednji">
          ...
          <div class="inputi">   
            <form action="/vesti/{{$novost['id']}}/editing" method="POST">
                @csrf
                    @method('PUT')
                  <table>
                  <tr>
                  <td class="Label"><label for="novinaslov"><h3>Novi naslov:</h3></label></td>
                  <td class="In"><input id="novinaslov" type="text" value="{{$novost['Naslov']}}" placeholder="{{$novost['Naslov']}}" name="Naslov"></td>
                  </tr>
                 <tr>
                <td class="Label"><label for="izmenaopisa"><h3>Novi opis:</h3></label></td>
                <td class="In"><textarea id="izmenaopisa" name="Opis"  placeholder="{{$novost['Opis']}}">{{$novost['Opis']}}</textarea><td>
                </tr>
              </table>
